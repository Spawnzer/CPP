...
/*   Updated: 2022/06/19 13:46:48 by adubeau          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Phonebook::addContact()
{
	...
	{
		std::cout << "|----ERROR, INVALID FIRST NAME-----|\n|";
		std::getline(std::cin, input);
	}
	...
	while (input.length() < 1)
	{
		std::cout << "|-----ERROR, INVALID LAST NAME-----|\n|";
		std::getline(std::cin, input);
	}
	this->contact[j].setLast(input);
	std::cout << "|------------NICKNAME--------------|\n|";
	std::getline(std::cin, input);
	while (input.length() < 1)
	{
		std::cout << "|------ERROR, INVALID NICKNAME-----|\n|";
		std::getline(std::cin, input);
	}
	this->contact[j].setNickname(input);
	...
	this->contact[j].setPhone(input);
	std::cout << "|----------DARKEST SECRET----------|\n|";
	std::getline(std::cin, input);
	while (input.length() < 1)
	{
		std::cout << "|------ERROR, INVALID SECRET-------|\n|";
		std::getline(std::cin, input);
	}
